...
После этого вы можете использовать любую из предложенных команд сборки (итоговые файлы попадаювт  папку __app__ корневой директории): <br>
...
│   ├── paрs                  # папка для хранения html-частей страницы
...
> Для подключения css-файлов используйте дирекgumport`
